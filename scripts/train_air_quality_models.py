...
def main() -> int:
    ...
    target_transformer = modeling.TargetTransformer(
    ...
    joblib.dump(inference_bundle, output_dirs["models"] / "inference_bundle.joblib")

    inference_contract = {
        "bundle": str(output_dirs["models"] / "inference_bundle.joblib"),
        "inputs": {
            "required": ["region", "pm2_5", "pm10", "so2"],
    ...
    (output_dirs["reports"] / "inference_contract.json").write_text(
